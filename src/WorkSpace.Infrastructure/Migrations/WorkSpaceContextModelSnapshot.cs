...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkSpace.Domain.Entities.Guest", b =>
            {
                ...
                // ... Các thuộc tính khác của Guest (FirstName, LastName, PhoneNumber) ...
                b.Property<string>("FirstName")
                    .IsRequired()
                    .HasMaxLength(100)
                    .HasColumnType("nvarchar(100)");
                ...
                b.ToTable("Guests");
            }); // <-- Dấu chấm phẩy kết thúc cấu hình Guest

            // ---------------------------------------------------------------------

            // --- Cấu hình cho thực thể ChatMessage ---
            modelBuilder.Entity("WorkSpace.Domain.Entities.ChatMessage", b =>
            {
                ...
                // ... Các thuộc tính khác của ChatMessage ...
                b.Property<DateTimeOffset>("CreateUtc")
                    .HasColumnType("datetimeoffset");

                // ... Các thuộc tính CreatedById, IsRead, LastModifiedById, LastModifiedUtc, ReadAtUtc ...
                b.Property<int?>("CreatedById")
                    .HasColumnType("int");
            ...
            }); // <-- Dấu chấm phẩy kết thúc cấu hình ChatMessage
